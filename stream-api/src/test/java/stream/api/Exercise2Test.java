...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void top3RichCustomer() {
         ...
         */
        Stream<String> top3RichCustomerStream = customerList.stream().sorted(Comparator.comparing(Customer::getBudget, Comparator.reverseOrder())).map(Customer::getName).limit(3);
